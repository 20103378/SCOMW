...
//	        	$("#value_select").combobox('select',CLdata[0].value);
	        	...
	        	$.ajax({
	                ...
	                cache: false,
	                type: 'POST',
	                url: "getDeviceByType.do?DeviceType="+DeviceType,
...
//     alert("Clldata="+Clldata);
	...
	{
		case "1":
			url="getStomChartValue.do";
			break;
		case "2":
			url="getSF6ChartValue.do";
			break;
		case "3":
			url="getSmoamChartValue.do";
			break;
		case "4":
			url="getScomChartValue.do";
			break;
		case "19":
			url="getSpdmChart_Value.do";
			break;
		case "hwcw":
			url="getInfraredChart_Value.do";
	}
	     $.ajax({
	         async: false,
	         cache: false,
