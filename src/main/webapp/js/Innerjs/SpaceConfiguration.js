...
//				                	$('#i2List').datagrid('reload');
			...
			if($("#tab_space").datagrid("getSelected")){
				...
				var path=ctxPath+"/view/com.scott/Graphs/";
				 $.ajax({
					 ...
					 cache:false,
					 type:'post',
					 url:"getDeviceBySpace.do?select_name="+select_name+"&path="+path,
					 success:function(data){
						 alert("生成XML文件成功!");
			        	 return
					 },
			...
			if($("#tab_space").datagrid("getSelected")){
				...
				var path=ctxPath+"/view/com.scott/Graphs/";
				 $.ajax({
					 ...
					 cache:false,
					 type:'post',
					 url:"ModDeviceBySpace.do?select_name="+select_name+"&path="+path,
					 success:function(data){
						 alert("修改XML文件成功!");
			        	 return
					 },
		...
		MapDeviceSet:function(){
			if($("#tab_space").datagrid("getSelected")){
				...
				$.ajax({
					...
					cache:false,
					type:'post',
					url:"getchangeXmlSwitchTo0.do?select_name="+select_name,
					success:function(data){
						alert("请到首页设备页拖动设备");
					},
					error:function(){
		...
		MapDeviceFinish:function(){
			...
			$.ajax({
				...
				cache:false,
				type:'post',
				url:"getchangeXmlSwitchTo1.do?select_name="+select_name,
				success:function(data){
					alert("设置完成");
				},
				error:function(){
