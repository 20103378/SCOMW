...
//
//import ems.airc.entity.DataacTblcurrentdata;
//import ems.energyUpload.entity.AreacodeT;
//import ems.entity.BaseTblcode;
//import ems.entity.BaseTblsection;
//import ems.entity.BaseTblzone;
//import ems.entity.SysTblcompany;
//import ems.entity.SysTbldepart;
//import ems.entity.SysTblsysmenu;
//import ems.gis.entity.GisMapHotArea;
//import ems.integrated.entity.BaseTblcheckquotadepart;
//import ems.integrated.entity.BaseTblcheckquotazone;
//import ems.integrated.entity.BaseTblquotadepart;
//import ems.integrated.entity.BaseTblquotazone;
//import ems.integrated.entity.EnergyQuota;
//import ems.integrated.entity.EneryBulletinZoneandDept;
//import ems.lineloss.entity.BaseTbllinelossrefrate;
//import ems.lineloss.entity.DayLinelossrefrate;
//import ems.lineloss.entity.MonthLinelossrefrate;
//import ems.lms.entity.BaseTblline;
//import ems.lms.entity.LampAreaNode;
//import ems.lms.entity.ZoneEmuLineNode;
//import ems.lms.entity.ZoneEmuNode;
//import ems.report.entity.RptDepartmentMonthAndEveryday;
//import ems.report.entity.RptDepartmentMonthByMonth;
//import ems.report.entity.RptMonthAndEveryday;
//import ems.report.entity.RptRecord;
//import ems.report.entity.RptZoneMonthByMonth;
//import ems.scada.entity.ScadaNode;
//import ems.scada.entity.SceneNode;
//import ems.sys.entity.BaseTbldevice;
//import ems.sys.entity.DepartUserNode;
//import ems.sys.entity.DeviceModelNode;
//import ems.sys.entity.EnergyConsumptionDevice;
...
public class TreeViewUtil<T> {
	...
	public TreeNode EntityToNode(T entity) { // SysTblsysmenu
		...
		// 区域终端树
			...
			if (item.getNodetype().equalsIgnoreCase("emu"))// 如果该数据为终端，则使用红色字体显示
			{
