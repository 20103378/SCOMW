...
function toCurrentData(data){
	...
	if(id.indexOf('C')>-1){
		...
		var url=encodeURI(ctxPath + '/deviceHealthState/DeviceDetail.do?DeviceID='+id+'&DeviceType='+nodetype+'&DeviceName='+nodetxt_DeviceDetail);
...
function toSpaceData(data){
	...
	var url=encodeURI(ctxPath + '/deviceHealthState/SpaceDetail.do?DeviceType='+data+'&DeviceName='+nodetxt);
	parent.jeecg.main.addTab(nodetxt,url);
}
