...
jeecg.yxHistory = function(){
	...
	var _this = {
			...
			ShowHistoryData:function(){
				...
				case "1":
					_box = null;
					_this.showYSPData.dataGrid.url="getstomYXHistoryData.do?id="+id+"&startTime="+startTime+"&endTime="+endTime+"&state="+state;
					_box = new YDataGrid(_this.showYSPData,table_name,false,true,true,true);
					_box.init();
					break;
				case "2":
					_box = null;
					_this.showSF6Data.dataGrid.url="getSf6YXHistoryData.do?id="+id+"&startTime="+startTime+"&endTime="+endTime+"&state="+state;
					_box = new YDataGrid(_this.showSF6Data,table_name,false,true,true,true);
					_box.init();
					break;
				case "3":
					_box = null;
					_this.showSF6Data.dataGrid.url="getSmoamYXHistory.do?id="+id+"&startTime="+startTime+"&endTime="+endTime+"&state="+state;
					_box = new YDataGrid(_this.showSF6Data,table_name,false,true,true,true);
					_box.init();
					break;
				case "4":
					_box = null;
					_this.showSF6Data.dataGrid.url="getScomYXHistoryData.do?id="+id+"&startTime="+startTime+"&endTime="+endTime+"&state="+state;
					_box = new YDataGrid(_this.showSF6Data,table_name,false,true,true,true);
					_box.init();
					break;
				case "19":
					_box = null;
					_this.showSF6Data.dataGrid.url="getSpdmYXHistoryData.do?id="+id+"&startTime="+startTime+"&endTime="+endTime+"&state="+state;
					_box = new YDataGrid(_this.showSF6Data,table_name,false,true,true,true);
					_box.init();
					break;
				}
