...
#login .logo {
 ...
 <body>
   ...
   <div class="inner">
    ...
    <div class="formLogin">
     <form name="formLogin" id="formLogin" action="loginController.do?login" check="checkuser.do" method="post">
      <div class="tip">
       <input class="userName" name="email" value="" type="text"  id="email"    title="用户名" iscookie="true"  nullmsg="请输入用户名!"/>
      </div>
      <div class="tip">
       <input class="password" name="pwd" value="" type="password"   id="pwd" title="密码"  nullmsg="请输入密码!"/>
      </div>
  ...
  <div id="versionBar">
   <div class="copyright">
    &copy; 版权所有
    <span class="tip"><a href="http://" title="SCAC-3000 在线监控系统">申昊科技股份有限公司</a> (推荐使用火狐浏览器FireFox17.0及以上版本;)<a href="#" title="SCAC-3000 在线监控系统">申昊科技股份有限公司</a></span>
   </div>
  </div>
  <!-- Link JScript-->
