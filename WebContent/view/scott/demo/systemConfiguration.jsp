						    ...
						    <form id="spaceForm" class="ui-form" method="post">
								<table id="tab_space_Form">
									...
									<tr>
										<td>电压等级</td>
										<td>
											<select id="txt_objectVoltage_A" class="easyui-combobox" style="width:100px;" panelHeight="50">
			                    				<option value ="AC">AC</option>
	 											<option value ="DC">DC</option>
		                    				</select>
		                    				<select id="txt_objectVoltage_O" class="easyui-combobox" style="width:100px;" panelHeight="100">
				...
				<div id="icdUpload-window" title="icd上传" style="width:400px;height:150px;font-size: 16">
				    <div data-options="region:'north',split:true" style="padding:10px">
					    <form id="pdfForm" action="" enctype="multipart/form-data" method="post">
                            ...
                            <input id="fileUrl" type="file" accept=".icd" style="width: 150px;" name="uploadFile" multiple="multiple"/>
                        </form>
					</div>
				</div>
             </div>
					    ...
					    <div data-options="region:'north',split:true" style="height:185px;padding:10px">
						    <form id="editForm3" class="ui-form" method="post">
								<table id="tab_I1ToI2">
									...
									<tr>
										<td>设备</td>
										<td><select id="sel_dname" class="easyui-combobox" style="width:100px;" panelHeight="150">
		                    				</select></td>
										<td><label id="msg_dname"> </label></td>
									</tr>
									<tr>
										<td>类型</td>
										<td><select id="sel_type" class="easyui-combobox" style="width:100px;" panelHeight="150">
		                    				</select></td>
										<td><label id="msg_type"> </label></td>
									</tr>
									<tr>
										<td>名称</td>
										<td><select id="sel_instName" class="easyui-combobox" style="width:100px;" panelHeight="150">
		                    				</select></td>
						...
						<div>
						  <fieldset id="data_field">
						    ...
						    <table>
						    	...
						    	<tr>
							    	<td>fc</td>
									<td colspan="1" ><select id="sel_fc" class="easyui-combobox" style="width:100px;" panelHeight="150">
		                   				</select></td>
